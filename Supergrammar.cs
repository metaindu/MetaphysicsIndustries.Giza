...
namespace MetaphysicsIndustries.Giza
{
    public class Supergrammar : Grammar
    {
        ...
        public Definition def_4_id_include = new Definition("id-include");
        ...
        public Definition def_9_expr = new Definition("expr");
        public Definition def_10_orexpr = new Definition("orexpr");
        public Definition def_11_subexpr = new Definition("subexpr");
        public Definition def_12_modifier = new Definition("modifier");
        public Definition def_13_number = new Definition("number");
        public Definition def_14_identifier = new Definition("identifier");
        public Definition def_15_literal = new Definition("literal");
        public Definition def_16_charclass = new Definition("charclass");
        public Definition def_17_unicodechar = new Definition("unicodechar");
        public Definition def_18_comment = new Definition("comment");
        ...
        public DefRefNode node_directive_item_0_id_002D_include;
        ...
        public CharNode node_id_include_0_include;
        public CharNode node_id_include_1_include;
        public CharNode node_id_include_2_include;
        public CharNode node_id_include_3_include;
        public CharNode node_id_include_4_include;
        public CharNode node_id_include_5_include;
        public CharNode node_id_include_6_include;
        ...
        public Supergrammar()
        {
            ...
            Definitions.Add(def_4_id_include);
            ...
            Definitions.Add(def_9_expr);
            Definitions.Add(def_10_orexpr);
            Definitions.Add(def_11_subexpr);
            Definitions.Add(def_12_modifier);
            Definitions.Add(def_13_number);
            Definitions.Add(def_14_identifier);
            Definitions.Add(def_15_literal);
            Definitions.Add(def_16_charclass);
            Definitions.Add(def_17_unicodechar);
            Definitions.Add(def_18_comment);

            node_grammar_0_definition = new DefRefNode(def_1_definition, "definition");
            node_grammar_1_comment = new DefRefNode(def_18_comment, "comment");
            ...
            node_definition_1_identifier = new DefRefNode(def_14_identifier, "identifier");
            node_definition_2__003D_ = new CharNode(CharClass.FromUndelimitedCharClassText("="), "=");
            node_definition_3_expr = new DefRefNode(def_9_expr, "expr");
            ...
            node_directive_item_0_id_002D_include = new DefRefNode(def_4_id_include, "id-include");
            ...
            def_3_directive_item.Nodes.Add(node_directive_item_0_id_002D_include);
            ...
            def_3_directive_item.StartNodes.Add(node_directive_item_0_id_002D_include);
            ...
            node_directive_item_0_id_002D_include.NextNodes.Add(node_directive_item_1_id_002D_whitespace);
            node_directive_item_2_id_002D_ignore.NextNodes.Add(node_directive_item_3_id_002D_case);

            def_4_id_include.Directives.Add(DefinitionDirective.IncludeWhitespace);
            def_4_id_include.Directives.Add(DefinitionDirective.IgnoreCase);
            node_id_include_0_include = new CharNode(CharClass.FromUndelimitedCharClassText("i"), "include");
            node_id_include_1_include = new CharNode(CharClass.FromUndelimitedCharClassText("n"), "include");
            node_id_include_2_include = new CharNode(CharClass.FromUndelimitedCharClassText("c"), "include");
            node_id_include_3_include = new CharNode(CharClass.FromUndelimitedCharClassText("l"), "include");
            node_id_include_4_include = new CharNode(CharClass.FromUndelimitedCharClassText("u"), "include");
            node_id_include_5_include = new CharNode(CharClass.FromUndelimitedCharClassText("d"), "include");
            node_id_include_6_include = new CharNode(CharClass.FromUndelimitedCharClassText("e"), "include");
            def_4_id_include.Nodes.Add(node_id_include_0_include);
            def_4_id_include.Nodes.Add(node_id_include_1_include);
            def_4_id_include.Nodes.Add(node_id_include_2_include);
            def_4_id_include.Nodes.Add(node_id_include_3_include);
            def_4_id_include.Nodes.Add(node_id_include_4_include);
            def_4_id_include.Nodes.Add(node_id_include_5_include);
            def_4_id_include.Nodes.Add(node_id_include_6_include);
            def_4_id_include.StartNodes.Add(node_id_include_0_include);
            def_4_id_include.EndNodes.Add(node_id_include_6_include);
            node_id_include_0_include.NextNodes.Add(node_id_include_1_include);
            node_id_include_1_include.NextNodes.Add(node_id_include_2_include);
            node_id_include_2_include.NextNodes.Add(node_id_include_3_include);
            node_id_include_3_include.NextNodes.Add(node_id_include_4_include);
            node_id_include_4_include.NextNodes.Add(node_id_include_5_include);
            node_id_include_5_include.NextNodes.Add(node_id_include_6_include);
            ...
            node_expr_0_subexpr = new DefRefNode(def_11_subexpr, "subexpr");
            node_expr_1_orexpr = new DefRefNode(def_10_orexpr, "orexpr");
            node_expr_2_comment = new DefRefNode(def_18_comment, "comment");
            def_9_expr.Nodes.Add(node_expr_0_subexpr);
            def_9_expr.Nodes.Add(node_expr_1_orexpr);
            def_9_expr.Nodes.Add(node_expr_2_comment);
            def_9_expr.StartNodes.Add(node_expr_0_subexpr);
            def_9_expr.StartNodes.Add(node_expr_1_orexpr);
            def_9_expr.StartNodes.Add(node_expr_2_comment);
            def_9_expr.EndNodes.Add(node_expr_0_subexpr);
            def_9_expr.EndNodes.Add(node_expr_1_orexpr);
            def_9_expr.EndNodes.Add(node_expr_2_comment);
            ...
            node_orexpr_1_expr = new DefRefNode(def_9_expr, "expr");
            node_orexpr_2__007C_ = new CharNode(CharClass.FromUndelimitedCharClassText("|"), "|");
            node_orexpr_3_expr = new DefRefNode(def_9_expr, "expr");
            node_orexpr_4__0029_ = new CharNode(CharClass.FromUndelimitedCharClassText(")"), ")");
            node_orexpr_5_modifier = new DefRefNode(def_12_modifier, "modifier");
            def_10_orexpr.Nodes.Add(node_orexpr_0__0028_);
            def_10_orexpr.Nodes.Add(node_orexpr_1_expr);
            def_10_orexpr.Nodes.Add(node_orexpr_2__007C_);
            def_10_orexpr.Nodes.Add(node_orexpr_3_expr);
            def_10_orexpr.Nodes.Add(node_orexpr_4__0029_);
            def_10_orexpr.Nodes.Add(node_orexpr_5_modifier);
            def_10_orexpr.StartNodes.Add(node_orexpr_0__0028_);
            def_10_orexpr.EndNodes.Add(node_orexpr_5_modifier);
            def_10_orexpr.EndNodes.Add(node_orexpr_4__0029_);
            ...
            node_subexpr_0_identifier = new DefRefNode(def_14_identifier, "identifier");
            node_subexpr_1_literal = new DefRefNode(def_15_literal, "literal");
            node_subexpr_2_charclass = new DefRefNode(def_16_charclass, "charclass");
            node_subexpr_3_modifier = new DefRefNode(def_12_modifier, "modifier");
            node_subexpr_4__003A_ = new CharNode(CharClass.FromUndelimitedCharClassText(":"), ":");
            node_subexpr_5_tag = new DefRefNode(def_14_identifier, "tag");
            def_11_subexpr.Nodes.Add(node_subexpr_0_identifier);
            def_11_subexpr.Nodes.Add(node_subexpr_1_literal);
            def_11_subexpr.Nodes.Add(node_subexpr_2_charclass);
            def_11_subexpr.Nodes.Add(node_subexpr_3_modifier);
            def_11_subexpr.Nodes.Add(node_subexpr_4__003A_);
            def_11_subexpr.Nodes.Add(node_subexpr_5_tag);
            def_11_subexpr.StartNodes.Add(node_subexpr_0_identifier);
            def_11_subexpr.StartNodes.Add(node_subexpr_1_literal);
            def_11_subexpr.StartNodes.Add(node_subexpr_2_charclass);
            def_11_subexpr.EndNodes.Add(node_subexpr_5_tag);
            def_11_subexpr.EndNodes.Add(node_subexpr_3_modifier);
            def_11_subexpr.EndNodes.Add(node_subexpr_0_identifier);
            def_11_subexpr.EndNodes.Add(node_subexpr_1_literal);
            def_11_subexpr.EndNodes.Add(node_subexpr_2_charclass);
            ...
            def_12_modifier.Nodes.Add(node_modifier_0__002A__002B__003F_);
            def_12_modifier.StartNodes.Add(node_modifier_0__002A__002B__003F_);
            def_12_modifier.EndNodes.Add(node_modifier_0__002A__002B__003F_);

            def_13_number.Directives.Add(DefinitionDirective.IncludeWhitespace);
            def_13_number.Directives.Add(DefinitionDirective.Atomic);
            node_number_0__005C_d = new CharNode(CharClass.FromUndelimitedCharClassText("\\d"), "\\d");
            def_13_number.Nodes.Add(node_number_0__005C_d);
            def_13_number.StartNodes.Add(node_number_0__005C_d);
            def_13_number.EndNodes.Add(node_number_0__005C_d);
            node_number_0__005C_d.NextNodes.Add(node_number_0__005C_d);

            def_14_identifier.Directives.Add(DefinitionDirective.IncludeWhitespace);
            def_14_identifier.Directives.Add(DefinitionDirective.Atomic);
            ...
            def_14_identifier.Nodes.Add(node_identifier_0__005C_l_002D__);
            def_14_identifier.Nodes.Add(node_identifier_1__005C_l_005C_d_002D__);
            def_14_identifier.StartNodes.Add(node_identifier_0__005C_l_002D__);
            def_14_identifier.EndNodes.Add(node_identifier_1__005C_l_005C_d_002D__);
            def_14_identifier.EndNodes.Add(node_identifier_0__005C_l_002D__);
            ...
            def_15_literal.Directives.Add(DefinitionDirective.IncludeWhitespace);
            ...
            node_literal_4_unicodechar = new DefRefNode(def_17_unicodechar, "unicodechar");
            node_literal_5__0027_ = new CharNode(CharClass.FromUndelimitedCharClassText("'"), "'");
            def_15_literal.Nodes.Add(node_literal_0__0027_);
            def_15_literal.Nodes.Add(node_literal_1__005E__005C__005C__0027_);
            def_15_literal.Nodes.Add(node_literal_2__005C_);
            def_15_literal.Nodes.Add(node_literal_3_rnt_005C__005C__0027_);
            def_15_literal.Nodes.Add(node_literal_4_unicodechar);
            def_15_literal.Nodes.Add(node_literal_5__0027_);
            def_15_literal.StartNodes.Add(node_literal_0__0027_);
            def_15_literal.EndNodes.Add(node_literal_5__0027_);
            ...
            def_16_charclass.Directives.Add(DefinitionDirective.IncludeWhitespace);
            ...
            node_charclass_4_unicodechar = new DefRefNode(def_17_unicodechar, "unicodechar");
            node_charclass_5__005D_ = new CharNode(CharClass.FromUndelimitedCharClassText("\\]"), "]");
            def_16_charclass.Nodes.Add(node_charclass_0__005B_);
            def_16_charclass.Nodes.Add(node_charclass_1__005E__005C__005C__005C__005B__005C__005D_);
            def_16_charclass.Nodes.Add(node_charclass_2__005C_);
            def_16_charclass.Nodes.Add(node_charclass_3_wldsrnt_005C__005C__005C__005B__005C__005D_);
            def_16_charclass.Nodes.Add(node_charclass_4_unicodechar);
            def_16_charclass.Nodes.Add(node_charclass_5__005D_);
            def_16_charclass.StartNodes.Add(node_charclass_0__005B_);
            def_16_charclass.EndNodes.Add(node_charclass_5__005D_);
            ...
            def_17_unicodechar.Directives.Add(DefinitionDirective.IncludeWhitespace);
            def_17_unicodechar.Directives.Add(DefinitionDirective.IgnoreCase);
            ...
            def_17_unicodechar.Nodes.Add(node_unicodechar_0__005C_x);
            def_17_unicodechar.Nodes.Add(node_unicodechar_1__005C_x);
            def_17_unicodechar.Nodes.Add(node_unicodechar_2__005C_dabcdef);
            def_17_unicodechar.Nodes.Add(node_unicodechar_3__005C_dabcdef);
            def_17_unicodechar.Nodes.Add(node_unicodechar_4__005C_dabcdef);
            def_17_unicodechar.Nodes.Add(node_unicodechar_5__005C_dabcdef);
            def_17_unicodechar.StartNodes.Add(node_unicodechar_0__005C_x);
            def_17_unicodechar.EndNodes.Add(node_unicodechar_5__005C_dabcdef);
            ...
            def_18_comment.Directives.Add(DefinitionDirective.IncludeWhitespace);
            ...
            def_18_comment.Nodes.Add(node_comment_0__002F__002A_);
            def_18_comment.Nodes.Add(node_comment_1__002F__002A_);
            def_18_comment.Nodes.Add(node_comment_2__005E__002A_);
            def_18_comment.Nodes.Add(node_comment_3__002A_);
            def_18_comment.Nodes.Add(node_comment_4__005E__002A__002F_);
            def_18_comment.Nodes.Add(node_comment_5__002A_);
            def_18_comment.Nodes.Add(node_comment_6__002F_);
            def_18_comment.Nodes.Add(node_comment_7__002F__002F_);
            def_18_comment.Nodes.Add(node_comment_8__002F__002F_);
            def_18_comment.Nodes.Add(node_comment_9__005E__005C_r_005C_n);
            def_18_comment.Nodes.Add(node_comment_10__005C_r_005C_n);
            def_18_comment.StartNodes.Add(node_comment_0__002F__002A_);
            def_18_comment.StartNodes.Add(node_comment_7__002F__002F_);
            def_18_comment.EndNodes.Add(node_comment_6__002F_);
            def_18_comment.EndNodes.Add(node_comment_10__005C_r_005C_n);
